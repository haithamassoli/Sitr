...
## Numbers — preliminary / noisy (2026-09-05, Apple M3, macOS 26.6.2, other agents building in parallel)
...
| cadence ≈ 15 fps under motion | 14.93 fps |
| cadence ≈ 0 on a static screen | 0 complete frames/s after the first second |

...
<img src="App/Icon/icon.png" width="128" alt="شعار ستر: عين محجوبة على خلفية زمردية">
...
لا يملك Sitr أيقونة في الـ Dock؛ ابحث عن أيقونة العين المشطوبة في شريط القائمة. يفتح التشغيل الأول نافذة إعداد. أسرع
طريق فيها هو زر **استخدام الإعدادات الافتراضية** في الشاشة الأولى: إخفاء الجميع (مع الوضع الصارم)، وتطبيق القواعد
الموصى بها، والتشغيل عند تسجيل الدخول، فلا يبقى سوى السماح بتسجيل الشاشة. ويمكن تغيير كل ذلك لاحقًا من الإعدادات. أما
زر **تخصيص** فيمر بالخطوات الخمس:
...
تعرض الإعدادات والقائمة أيضًا حالة تجهيز الحماية ونطاقها واستعادة التقاط الشاشة. إذا توقف الالتقاط مع بقاء الإذن، يتوفر خيار إعادة المحاولة. أما فقدان الإذن فيتيح فتح إعدادات تسجيل الشاشة. يوقف الإيقاف المؤقت أو التعطيل التقاط الشاشة وتحليلها، ثم تُستأنف الحماية من إطار جديد.

إذا تعذّر حفظ القواعد، تبقى رسالة إعادة المحاولة ظاهرة. لا يتغير ملف القواعد غير المقروء حتى تعيد قراءته أو تختار إعادة تعيينه، مع الاحتفاظ بنسخة للاستعادة. يمكنك إعادة تعيين المظهر وحده دون تغيير قواعد الحماية.
...
و٦٠ ملّي ثانية في وضع الستارة عند التقاط ٣٠ إطارًا في الثانية؛ استجابة ضغط أو إفلات الكشف المؤقت خلال إطار واحد؛ أقل من ١٪ من المعالج عند سكون الشاشة،
...
هذه أهداف أداء. تتوفر القياسات الحالية والاختبارات المتبقية في [نتائج التحسين](docs/improvement-results.md).
